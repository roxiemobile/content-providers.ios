...
// MARK: - Construction
    ...
    convenience init(code: NSError.DatabaseError.Code, description: String? = nil) {
        self.init(
            ...
            code: code.rawValue,
            userInfo: (description != nil) ? [NSLocalizedDescriptionKey: description!] : nil
        )
    }
    ...
    convenience init(code: NSError.SerializationError.Code, description: String? = nil) {
        self.init(
            domain: SerializationError.Domain,
            code: code.rawValue,
            userInfo: (description != nil) ? [NSLocalizedDescriptionKey: description!] : nil
        )
    }
...
// MARK: - Properties
    ...
    class var databaseIsInvalid: NSError {
        ...
        struct Singleton {
            static let error = NSError(
                code: DatabaseError.Code.databaseIsInvalid,
    ...
    class var inputIsInvalid: NSError {
        ...
        struct Singleton {
            static let error = NSError(
                code: DatabaseError.Code.inputIsInvalid,
    ...
    class var modelIsInvalid: NSError {
        ...
        struct Singleton {
            static let error = NSError(
                code: DatabaseError.Code.modelIsInvalid,
